import { Container, Row, Col, Image, Button, Card } from 'solid-bootstrap';

export const Home = () => {
    return (
        <Container>
            <Row class='px-4 mt-5 mb-5'>
                <Col sm={7}><Image src="https://picsum.photos/900/400" fluid rounded /></Col>
                <Col sm={5}>
                    <h1 class='font-weight-light'>Monster Truck International</h1>
                    <p>
            ...
            <Row>
                <Card class='bg-primary text-white mb-5 py-1'>
                    <Card.Body>
                        <Card.Title>
